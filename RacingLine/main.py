...
class MainWindow(MDBoxLayout):
    ...
    def update(self, dt):
        ...
        self.accelerating_force = ACCELERATING_FORCE if self.key_up_active else self.accelerating_force = 0
        self.braking_force = BRAKING_FORCE if self.key_down_active else self.braking_force = 0
        self.acceleration = calculate_acceleration(self.accelerating_force, self.braking_force, self.vehicle_speed)
